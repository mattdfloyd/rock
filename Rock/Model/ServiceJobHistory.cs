...
namespace Rock.Model
{
    ...
    public partial class ServiceJobHistory : Model<ServiceJobHistory>
    {
        ...
        /// <summary>
        /// Gets or sets the IP address of the service worker.
        /// </summary>
        /// <value>
        /// A <see cref="System.String"/> representing the IP address of the service worker.
        /// </value>
        [MaxLength( 45 )]
        [DataMember]
        public string ServiceWorkerIpAddress { get; set; }
